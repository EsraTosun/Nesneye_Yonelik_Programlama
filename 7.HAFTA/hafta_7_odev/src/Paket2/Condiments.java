...
public class Condiments extends Urun 
{
	...
	{
		cesniBirimAgirlikGuncelle(CondimentsList, yeniAgirlik);
	}

	protected static void cesniBirimAgirlikGuncelle(ArrayList<Condiments> CondimentsList,String yeniAgirlik)
	{
